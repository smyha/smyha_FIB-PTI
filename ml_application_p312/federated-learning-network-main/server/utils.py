...
def model_params_to_request_params(training_type, model_params):
    #print('First in server, in utils, mod->req: model_params = ', model_params)
    ...
    if training_type == TrainingType.MNIST:
        ...
        #print('in server, in utils, mod->req: model_params = ', model_params)
        weights_array = []
...
def request_params_to_model_params(training_type, request_data):
    ...
    if training_type == TrainingType.MNIST:
        ...
        #print('in server, in utils, req->mod: request data = ', request_data)
        if 'weights' in request_data:
            ...
            #print('in server, in utils, req->mod: model_params = ', model_params)
        else:
