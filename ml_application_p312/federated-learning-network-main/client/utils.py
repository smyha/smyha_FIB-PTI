...
def model_params_to_request_params(training_type, model_params):
    ...
    if training_type == TrainingType.MNIST:
        ...
        #print('in client: in utils (mod to req) len(weight_array ', len(weights_array))    
        #print('in utils (mod to req) request_data ', weights_array)
...
def request_params_to_model_params(training_type, request_data):
    ...
    if training_type == TrainingType.MNIST:
        ...
        #print('in client, in utils (req to model) request_data ', request_data)
        if 'weights' in request_data:
            ...
            #print('in utils (req to model) model_params ', model_params)
        else:
