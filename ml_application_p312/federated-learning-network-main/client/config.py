...
USE_TRAINED_MODEL = False #True # False: start training from scratch. True: use previously trained model
...
if environ.get('CLIENT_URL') == 'http://localhost:5001':
    ...
    #NITIAL_MODEL_PATH = '/keras_model1/model.model.keras'   #FF 20/06/2025
